...
D3DXVECTOR4					g_WorldCameraPos(0.0f, -20.0f, -500.0f, 1.0f);
...
void RenderScene()
{
	...
	////
	D3DXMatrixTranslation(&matTm, v.x, v.y, v.z);
	D3DXMatrixRotationY(&matR, t);
	t += 0.05f;
	...
	g_pLightShader->SetTexture("DiffuseMap_Tex", g_pEarthDM);
